...
declare global {
  var __justinKitActivityStatusStore: ActivityStatusStore | undefined;
}

export const activityStatusStore =
  globalThis.__justinKitActivityStatusStore ??
  (globalThis.__justinKitActivityStatusStore = new ActivityStatusStore());
